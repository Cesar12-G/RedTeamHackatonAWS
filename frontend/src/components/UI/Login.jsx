...
export const Login = () => {
  ...
  return (
    <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
      ...
      >
        <div
          className="p-4 py-6 text-white bg-rose-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
          ...
          <p className="flex flex-col items-center justify-center mt-10 text-center">
            ...
            <a href="#" className="underline">Creala ahora!</a>
          </p>
