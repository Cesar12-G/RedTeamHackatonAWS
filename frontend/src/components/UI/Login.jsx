...
export const Login = () => {
    return (
        <div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
            ...
            >
                <div
                    class="p-4 py-6 text-white bg-rose-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
                >
                    ...
                    <form action="#" class="flex flex-col space-y-5">
                        <div class="flex flex-col space-y-1">
                            ...
                            <input
                                ...
                                id="email"
                                autofocus
                                class="px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-teal-300"
                            />
                        </div>
                        <div class="flex flex-col space-y-1">
